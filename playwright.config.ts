...
export default defineConfig({
  ...
  webServer:[
    {command:"OIDC_ISSUER_URL=https://identity.example.com OIDC_AUDIENCE=odls-api DATABASE_URL=postgresql://odls:odls@127.0.0.1:5432/odls JWT_SECRET=replace-with-a-32-character-development-secret CORE_SERVICE_PORT=3101 services/core-service/node_modules/.bin/tsx services/core-service/src/server.ts",url:"http://127.0.0.1:3101/ready",reuseExistingServer:false,timeout:30_000},
