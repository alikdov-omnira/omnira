...
describe("OMNIRA product branding",()=>{
 ...
 it("renders OMNIRA on login without the old visible product brand",()=>{auth.set(null);const html=renderToStaticMarkup(<App/>);expect(html).toContain("OMNIRA");expect(html).toContain("AI Business Operating System");expect(html).toContain("One platform. Every business.");expect(html).not.toContain("ODLS Platform");});
