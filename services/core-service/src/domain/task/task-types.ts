...
export interface Task {
  ...
  assignees:TaskAssignee[];version:number;createdAt:string;updatedAt:string;archivedAt:string|null;
}
...
export type TaskLifecycleAction="start"|"block"|"resume"|"complete"|"cancel";
